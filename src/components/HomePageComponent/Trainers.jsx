...
import trainerImg from '../../assets/trainer.png'; // adjust path if needed
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {trainers.map((trainer, index) => (
            <div
              key={index}
              className="bg-[#1b1c1f] rounded-xl p-6 shadow-md hover:scale-105 transform transition duration-300"
            >
              <img
                src={trainer.image}
                alt={trainer.name}
